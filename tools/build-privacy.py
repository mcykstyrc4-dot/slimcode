...
SECTIONS = [
    ...
    ('Оператор может обрабатывать следующие персональные данные Пользователя', P(
        ...
        'Персональные данные.',
        '5.6. Сведения о состоянии здоровья Пользователя (жалобы, противопоказания, результаты '
        'измерений, назначения специалиста) относятся к специальной категории персональных '
        'данных. ' + FILL('Уточнить: собираются ли такие сведения и на каком носителе') + '. '
        'Через сайт такие сведения не собираются: форма записи запрашивает только имя, телефон '
        'и выбранную услугу.',
    ...
    ('Порядок сбора, хранения, передачи и других видов обработки персональных данных',
     ...
     + '\n' + L(
       ...
       'документы, срок хранения которых установлен законодательством, — в течение '
