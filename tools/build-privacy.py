...
SITE = '<a href="https://slim-code.ru" target="_blank" rel="noopener">https://slim-code.ru</a>'
...
PREAMBLE = (
    ...
    'ИП Колодзей Татьяна Николаевна (далее – Оператор).'
)
...
SECTIONS = [
    ...
    ('Оператор может обрабатывать следующие персональные данные Пользователя', P(
        ...
        '5.3. Также на сайте происходит сбор и обработка обезличенных данных о посетителях '
        ...
        '5.7.1 Согласие на обработку персональных данных, разрешенных для распространения, '
        ...
        '5.7.4 Согласие на обработку персональных данных, разрешенных для распространения, '
        'прекращает свое действие с момента поступления Оператору требования, указанного '
        'в п. 5.7.3 настоящей Политики в отношении обработки персональных данных.')),
    ...
    ('Правовые основания обработки персональных данных',
     ...
     + '\n\n' + P(
        ...
        'расположенные на сайте ' + SITE + ' или направленные Оператору посредством электронной '
    ...
    ('Порядок сбора, хранения, передачи и других видов обработки персональных данных', P(
        ...
        'электронной почты Оператора ' + MAIL + ' с пометкой «Актуализация персональных данных».',
        ...
        'адрес Оператора ' + MAIL + ' с пометкой «Отзыв согласия на обработку персональных '
        'данных».',
    ...
    ('Заключительные положения', P(
        ...
        'по адресу <a href="https://slimcodelab.ru/privacy.html">https://slimcodelab.ru/privacy</a>.')),
]
...
</main>""" % ('Оператор: ИП Колодзей Татьяна Николаевна', toc, P(PREAMBLE), body) + s[end:]
