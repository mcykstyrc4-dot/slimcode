...
OPERATOR_LINE = 'Оператор: ООО «Слим Код»'
...
PREAMBLE = (
    ...
    'Обществом с ограниченной ответственностью «Слим Код» (далее — Оператор).<br>'
    'ИНН 7807280704, ОГРН 1247800095542, '
    'адрес для направления обращений: 198335, Санкт-Петербург, Ленинский пр-кт, '
    'д. 64, к. 1, литера А, кв. 576, '
    'электронная почта: ' + MAIL + '.<br>'
    'Медицинские услуги в салонах сети Slim Code Lab Оператор оказывает на основании '
    'лицензии на осуществление медицинской деятельности Л041-01148-78/03316215, выданной '
    'Комитетом по здравоохранению Санкт-Петербурга 6 октября 2025 года.'
)
...
SECTIONS = [
    ...
    ('Порядок сбора, хранения, передачи и других видов обработки персональных данных',
     ...
     + '\n' + L(
       ...
       'на процедуру не состоялась, — 1 год с даты обращения;',
       'сведения о клиенте, обратившемся за услугой, — в течение срока обслуживания и '
       '3 года после последнего визита;',
...
%s
    ...
    s = re.sub(r'<meta name="description" content="[^"]*">',
               ...
               'ООО «Слим Код» — сеть салонов Slim Code Lab.">', s, count=1)
